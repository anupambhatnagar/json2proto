...
const char descriptor_table_protodef_addressbook_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "utorial.PersonB\225\001\n\033com.example.tutorial."
  "protosB\021AddressBookProtosP\001Z:github.com/"
  "protocolbuffers/protobuf/examples/go/tut"
  "orialpb\252\002$Google.Protobuf.Examples.Addre"
  "ssBookb\006proto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_addressbook_2eproto = {
    false, false, 454, descriptor_table_protodef_addressbook_2eproto,
    "addressbook.proto",
